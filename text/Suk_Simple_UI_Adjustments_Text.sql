...
--========================================================================================================================
		...
		VALUES
			...
			('LOC_SUK_SUA_PLACE_BLD_KEY',			'zh_Hant_HK',	"图例"),
			('LOC_SUK_SUA_PLACE_BLD_ADJACENCIES',	'zh_Hant_HK',	"相邻加成"),
			('LOC_SUK_SUA_PLACE_BLD_WORKERS',		'zh_Hant_HK',	"专家相邻加成背书"),
			('LOC_SUK_SUA_PLACE_BLD_TO_OTHERS',		'zh_Hant_HK',	"提供相邻加成"),
			('LOC_SUK_SUA_PLACE_BLD_BASE_YIELD',	'zh_Hant_HK',	"基础产出"),
			('LOC_SUK_SUA_PLACE_BLD_WAREHOUSE',		'zh_Hant_HK',	"改良设施加成"),
			('LOC_SUK_SUA_PLACE_BLD_OVERBUILD',		'zh_Hant_HK',	"产出损失"),
			('LOC_SUK_SUA_PLACE_BLD_UNWORKED',		'zh_Hant_HK',	"潜在损失"),
